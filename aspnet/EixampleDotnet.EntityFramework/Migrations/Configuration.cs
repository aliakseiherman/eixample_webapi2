namespace EixampleDotnet.EntityFramework.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EixampleDotnet.EntityFramework.AppDbContext>
    {
        ...
        protected override void Seed(EixampleDotnet.EntityFramework.AppDbContext context)
        {
